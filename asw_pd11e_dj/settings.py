...
STATIC_URL = "/static/"
STATICFILES_DIRS = [BASE_DIR / "static"]  # CSS/JS personalitzat
STATIC_ROOT = BASE_DIR / "staticfiles"    # Carpeta per collectstatic

# Media files (per avatars, banners, uploads)
MEDIA_URL = "/media/"
