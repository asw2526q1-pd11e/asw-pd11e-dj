...
urlpatterns = [
    ...
    path("users/me/comments/", MyCommentsAPIView.as_view(), name="my_comments"),
    ...
    path('api/posts/<int:post_id>/toggle_saved/', ToggleSavedPostAPIView.as_view(), name='api_toggle_saved_post'),
    path('api/comments/<int:comment_id>/toggle_saved/', ToggleSavedCommentAPIView.as_view(), name='api_toggle_saved_comment'),

    # Endpoints de usuarios específicos
    path('users/<int:user_id>/', UserProfileAPIView.as_view(), name='user-profile'),
    path('users/<int:user_id>/posts/', UserPostsAPIView.as_view(), name='user-posts'),
    path('users/<int:user_id>/comments/', UserCommentsAPIView.as_view(), name='user-comments'),
    path('users/<int:user_id>/saved-posts/', UserSavedPostsAPIView.as_view(), name='user-saved-posts'),
    path('users/<int:user_id>/saved-comments/', UserSavedCommentsAPIView.as_view(), name='user-saved-comments'),
]